...
if ( ! function_exists( 'aliaala01sttheme_pagination' ) ) {
	/**
	 ...
	 */
	function aliaala01sttheme_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'aliaala01sttheme' ),
				'next_text'          => __( '&raquo;', 'aliaala01sttheme' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'aliaala01sttheme' ),
			)
		);
