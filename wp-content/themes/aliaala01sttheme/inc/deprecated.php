...
if ( ! function_exists( 'aliaala01sttheme_adjust_body_class' ) ) {
	/**
	 * Setup body classes.
	 *
	 ...
	 */
	function aliaala01sttheme_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'aliaala01sttheme_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function aliaala01sttheme_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'aliaala01sttheme' ),
		__( 'Previous', 'aliaala01sttheme' ),
		__( 'Next', 'aliaala01sttheme' ),
		__( 'About:', 'aliaala01sttheme' ),
		__( 'Profile', 'aliaala01sttheme' ),
		__( 'Posts by', 'aliaala01sttheme' ),
		__( 'Permanent Link:', 'aliaala01sttheme' ),
		__( 'in', 'aliaala01sttheme' ),
		__( 'Edit', 'aliaala01sttheme' ),
	);
}
