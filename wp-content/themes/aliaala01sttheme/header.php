...
<body <?php body_class(); ?> <?php aliaala01sttheme_body_attributes(); ?>>
...
<div class="site" id="page">
	...
	<header id="wrapper-navbar">
		...
		<a class="skip-link sr-only sr-only-focusable" href="#content"><?php esc_html_e( 'Skip to content', 'aliaala01sttheme' ); ?></a>
